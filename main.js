            ...
            rings: {
                ...
                groups: [
                    ...
                    },
                    {
                        ...
                        items: [
                            { id: "rng2_1", name: "Life Ring +2", desc: "NG++: Lothric Castle na półce za smokiem (gzyms?)." },
                            { id: "rng2_2", name: "Life Ring +3", desc: "NG++: Untended Graves za tronem w nocy." },
                            { id: "rng2_3", name: "Chloranthy Ring +2", desc: "NG++: Road of Sacrifices na półce skalnej pod magiem." },
                            { id: "rng2_4", name: "Havel's Ring +2", desc: "NG++: Anor Londo w wieży Yorshki." },
                            ...
                            { id: "rng2_7", name: "Magic Stoneplate Ring +2", desc: "NG++: Profaned Capital przy schodach na krawędzi." },
                            { id: "rng2_8", name: "Flame Stoneplate Ring +2", desc: "NG++: Smouldering Lake w ruinach przy czarnym rycerzu." },
                            { id: "rng2_9", name: "Thunder Stoneplate Ring +2", desc: "NG++: Lothric Castle na dachu." },
                            { id: "rng2_10", name: "Dark Stoneplate Ring +2", desc: "NG++: Farron Keep za ścianą przy jednym z pieców." },
                            ...
                            { id: "rng2_13", name: "Lingering Dragoncrest Ring +2", desc: "NG++: Grand Archives(Lothric Castle) na dachu wieży." },
                            { id: "rng2_14", name: "Sage Ring +2", desc: "NG++: Consumed King's Garden przy wieży z windą." },
                            { id: "rng2_15", name: "Wood Grain Ring +2", desc: "NG++: Irithyll of the Boreal Valley za budynkiem z trzema srebrynmi rycerzami." },
